...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="">HSBLOG</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="">H-ui</a> <span class="logo navbar-slogan f-l mr-10 hidden-xs">v0.1</span> <a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
            ...
            <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
                <ul class="cl">
                    ...
                    <?php }else{ ?>
                    <script>  location.href="<?php echo U('Home/Index/index');?>" </script>
                    <?php } ?>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="<?php echo U('Admin/Article/article_list');?>" data-title="文章管理" href="javascript:void(0)">文章管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active"><span title="欢迎页" data-href="welcome.html">欢迎页</span><em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?php echo U('Admin/Index/weclome');?>"></iframe>
        </div>
    </div>
</section>
